(function () {
  ...
  const SEARCH_PRODUTOS = [
    ...
    { code: 'SH-1069', name: 'Meia Aliança Pedras Ovais', material: 'Meia aliança · Pedras ovais · Ouro 18k', preco: 'A consultar', foto: 'images/SH-1069.jpg', categoria: 'aparadores' },
  ];
